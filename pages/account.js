                ...
                <article className="vcPage-content vcAccount">
                    <div className="vcAccount-wrap flex flex-col lg:flex-row">
                        <div className="vcAccount-tabs">
                            ...
                            <button className="tablink">Billing Info</button>
                            <button className="tablink">Reset Password</button>
                            <button className="tablink">Recent Orders</button>
                            <button className="tablink">Saved Items</button>
                        </div>

                        <div className="vcAccount-content">
                            ...
                            {/* <div id="vcBilling-tab" className="tabcontent">
                                ...
                                <form className="vcBilling-details flex flex-col justify-center">
                                    <label htmlFor="vcBilling-check" className="vcFilter-label">
                                        <input type="checkbox" id="vcBilling-check" defaultChecked />
