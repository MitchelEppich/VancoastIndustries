    ...
    return (
        <div id="vcEditor" className="tabcontent">
            ...
            <input
                ...
                <div className="flex">
                    <input type="button" onClick={() => props.setAddressToEdit(null)} style={{ background: "#cecece" }} className="rounded font-bold mr-2 text-black w-1/2 cursor-pointer hover:opacity-50" value="Cancel" />
