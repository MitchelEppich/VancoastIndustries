...
const footer = props => {
    return (
        <footer className="flex flex-col justify-around">
            <div className="vcSubscribe-box-wrap flex justify-end">
                <div className="vcSubscribe-box">
                    ...
                    <form action="/action_page.php">
                        <input className="vcNewsletter-input" type="text" placeholder="email" />
                        <input className="vcNewsletter-btn" type="submit" value="Subscribe" />
                    </form>
                </div>
            </div>
            ...
            <div className="vcFooter-copy-wrap flex justify-center">
