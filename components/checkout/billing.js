        ...
        <React.Fragment>
            <div className="vcCheckout-content">
                <form className="vcWholesale-application flex flex-col justify-center">
                    ...
                    <input type="text" id="vcName" placeholder="First Name" />
                    ...
                    <input type="text" id="vcStreet" placeholder="" />

                    <label htmlFor="vcProvince">Province/State*</label>
                    <input type="text" id="vcProvince" placeholder="" />
                    ...
                    <select className="vcCountry" name="vcCountry">
                        ...
                        <option value="MK">Macedonia, the htmlFormer Yugoslav Republic of</option>
                    ...
                    <textarea type="textarea" id="vcMessage" rows="10" placeholder="Special delivery instructions" />
                </form>
            </div>

            <input
                onClick={() => props.changeStep("Payment")}
                type="submit"
